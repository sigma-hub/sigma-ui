...
it('resolve import', async () => {
  expect(
    resolveImport('@/foo/bar', {
      absoluteBaseUrl: '/Users/sigma-ui/Projects/foobar',
      paths: {
        '@/*': ['./src/*'],
  ...
  ).toEqual('/Users/sigma-ui/Projects/foobar/src/foo/bar');
  ...
  ).toEqual('/Users/sigma-ui/Projects/foobar/src/components/foo/bar/baz');
  ...
  ).toEqual('/Users/sigma-ui/Projects/foobar/src/app/components/foo/bar');
  ...
  ).toEqual('/Users/sigma-ui/Projects/foobar/lib/utils');
});
