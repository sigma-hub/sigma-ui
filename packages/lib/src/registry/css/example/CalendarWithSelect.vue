...
<template>
  <CalendarRoot
    ...
    v-bind="forwarded"
    class="example-sigma-ui-calendar-select"
  >
    <CalendarHeader>
      <CalendarHeading class="example-sigma-ui-calendar-select__heading">
        <Select
        ...
        >
          <SelectTrigger
            ...
            class="example-sigma-ui-calendar-select__month-trigger"
          >
            <SelectValue placeholder="Select month" />
          </SelectTrigger>
          <SelectContent class="example-sigma-ui-calendar-select__month-content">
            <SelectItem
        ...
        >
          <SelectTrigger
            ...
            class="example-sigma-ui-calendar-select__year-trigger"
          >
            <SelectValue placeholder="Select year" />
          </SelectTrigger>
          <SelectContent class="example-sigma-ui-calendar-select__year-content">
            <SelectItem
    ...
    <div class="example-sigma-ui-calendar-select__grid-container">
      <CalendarGrid
        v-for="month in grid"
      ...
      >
        ...
        <CalendarGridBody class="example-sigma-ui-calendar-select__grid">
          <CalendarGridRow
            v-for="(weekDates, index) in month.rows"
            :key="`weekDate-${index}`"
            class="example-sigma-ui-calendar-select__week-row"
          >
            <CalendarCell
...
.example-sigma-ui-calendar-select__month-trigger {
  width: 60%;
}

.example-sigma-ui-calendar-select__year-trigger {
  width: 40%;
}

.example-sigma-ui-calendar-select__month-content,
.example-sigma-ui-calendar-select__year-content {
  max-height: 200px;
}
